...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(5).setHeaderValue("Estado de salud");
        }
        ...
        if (jTable2.getColumnModel().getColumnCount() > 0) {
            jTable2.getColumnModel().getColumn(3).setHeaderValue("Peso");
            jTable2.getColumnModel().getColumn(4).setHeaderValue("Sexo");
            jTable2.getColumnModel().getColumn(5).setHeaderValue("Estado de salud");
        }
